...
word_list = {
  "Alcohol-Themes" => %w(beer shot drunk intoxicated vodka wine Grange Champagne alcoholic drink),
  ...
  "Generic Verbs-Basics" => %w(be see say get make go know take see come think look want give use find tell ask work seem feel try leave call have do are is go get do ask run kiss think ),
